...
guardian, to place an order. You agree to provide accurate information and not to
misuse the site (no fraud, scraping, hacking, or reselling in a way that breaks
these terms).
...
Delivery is covered in our **Shipping Policy**, and your right to return is
covered in our **Returns & Refunds** policy. Both form part of these terms. Risk
of loss passes to you once the order is delivered to the address you provided.

## 6. Discount codes

Codes (like WELCOME10) are subject to their own conditions, can't be combined
unless stated, have no cash value, and may be withdrawn at any time.

## 7. Intellectual property

The SUPERNOVA name, logo, designs, graphics, and all site content are ours (or
used under licence). You may not copy, reproduce, or use them commercially
...
time of your order is the one that applies.
